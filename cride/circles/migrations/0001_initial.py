# Generated by Django 3.0.14 on 2021-07-16 08:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified', models.BooleanField(default=False, help_text='Verified circles are also know as oficial comunities', verbose_name='verified circle')),
                ('is_public', models.BooleanField(default=True, help_text='Public circles are listed in the main page so everybody know about their existense')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If circle is limited sets the member limit of the circle')),
            ],
            options={
